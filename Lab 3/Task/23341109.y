...
symbol_table* symbolTable = new symbol_table(9);
...
start : program
	{
		...
		symbolTable->print_all_scopes(outlog);
	}
	;
...
int main(int argc, char *argv[])
{
	...
	outlog<<"New ScopeTable with ID "<<symbolTable->get_current_scope_id()<<" created"<<endl<<endl;
